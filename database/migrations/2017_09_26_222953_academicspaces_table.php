...
class AcademicspacesTable extends Migration
{
    ...
    public function up()
    {
      Schema::create('academicspaces', function (Blueprint $table) {
        ...
        $table->string('nucleoTematico',900)->default('por diligenciar')->nullable();
        $table->string('justificacion',900)->default('por diligenciar')->nullable();
        $table->string('metodologia',900)->default('por diligenciar')->nullable();
        $table->string('evaluacion',900)->default('por diligenciar')->nullable();
        $table->string('descripcion',1000)->default('por diligenciar')->nullable();
        $table->string('competenciasPropias',900)->default('por diligenciar')->nullable();
        $table->string('contenidoConceptual',900)->default('por diligenciar')->nullable();
        $table->string('contenidoProcedimental',900)->default('por diligenciar')->nullable();
        $table->string('contenidoActitudinal',900)->default('por diligenciar')->nullable();
        $table->string('procesosIntegrativos',900)->default('por diligenciar')->nullable();
        $table->string('unidades',900)->default('por diligenciar')->nullable();
        $table->string('bibliografia',2000)->default('por diligenciar')->nullable();
        $table->string('recursosElectronicos',900)->default('por diligenciar')->nullable();
